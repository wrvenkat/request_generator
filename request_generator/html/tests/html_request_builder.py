...
GEN_OUTPUT_DIR = "html/tests/gen_test_html_poc"

class HtmlRequestBuilderTest(unittest.TestCase):
    ...
    def parse_and_build_dom(self, request_file_names=[], type=Type.form_request,
        ...
        #trigger build
        request_dom.build(type=type, target_type=target_type, auto_submit=auto_submit)
    ...
    def test_a_single_request_get_form_1(self):
        request_file_names = [self.simple_get_request]

        request_file_name = "a_single_request_get_form_1"
        #iframe
    ...
    def test_b_single_request_get_xhr_1(self):
        request_file_names = [self.simple_get_request]
    ...
    def test_c_single_request_get_form_2(self):
        request_file_names = [self.simple_get_request_with_query_string]

        #generate file name
        request_file_name = "c_single_request_get_form_2"
        dom = self.parse_and_build_dom(request_file_names=request_file_names,
                                type=Type.form_request,
                                target_type=TargetType.iframe,
                                auto_submit=True)
    ...
    def test_d_single_request_get_xhr_2(self):
        request_file_names = [self.simple_get_request_with_query_string]
    ...
    def test_e_single_request_post_form(self):
        request_file_names = [self.post_request_with_query_string]

        request_file_name = "e_single_request_post_form_1"
        dom = self.parse_and_build_dom(request_file_names=request_file_names,
                                type=Type.form_request,
                                target_type=TargetType.iframe,
                                auto_submit=True)
    ...
    def test_f_single_request_post_xhr(self):
        request_file_names = [self.post_request_with_query_string]
    ...
    def test_g_single_request_post_plain_text_form(self):
        request_file_names = [self.post_request_plain_text]
        
        request_file_name = "g_single_request_post_plain_text_form"
        dom = self.parse_and_build_dom(request_file_names=request_file_names,
                                type=Type.form_request,
                                target_type=TargetType.iframe,
                                auto_submit=True)
    ...
    def test_h_single_request_post_plain_text_xhr(self):
        request_file_names = [self.post_request_plain_text]
    ...
    def test_i_single_request_multi_part_post_form(self):
        """
        ...
        request_file_name = "i_single_request_multi_part_form"
        dom = self.parse_and_build_dom(request_file_names=request_file_names,
                                type=Type.form_request,
                                target_type=TargetType.iframe,
                                auto_submit=True)
    ...
    def test_j_single_request_multi_part_post_xhr(self):
        """
        Tests building an HTML with form based CSRF request
        for a multipart/form-data request.
        """
    ...
    def test_k_multi_request_form(self):
        request_file_names = [  self.simple_get_request,
        ...
        request_file_name = "k_multi_request_form"
        dom = self.parse_and_build_dom(request_file_names=request_file_names,
                                type=Type.form_request,
                                target_type=TargetType.iframe,
                                auto_submit=True)
    ...
    def test_l_multi_request_xhr(self):
        request_file_names = [  self.simple_get_request,
                                self.simple_get_request_with_query_string,
                                self.post_request_with_query_string,
                                self.post_request_plain_text,
